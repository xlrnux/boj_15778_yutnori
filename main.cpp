...
const int PATTERN[39][6] = {
        ...
        {-100,21,22,23,24,15},
        {-100,22,23,24,15,16},
        {-100,27,28,29,30,30}, // 22
        {-100,24,15,16,17,18},
        {-100,15,16,17,18,19},
        {-100,26,22,27,28,29},
        {-100,22,27,28,29,30}, //26
        {-100,28,29,30,30,30},
        {-100,29,30,30,30,30},
        {-100,30,30,30,30,30},
        {-100,30,30,30,30,30}, // 30
        {-100,1,2,3,4,5}, // 'A' ~ 'D', 'a'~'d' 스타트
        {-100,1,2,3,4,5},// 'A' ~ 'D', 'a'~'d' 스타트
        {-100,1,2,3,4,5},// 'A' ~ 'D', 'a'~'d' 스타트
        {-100,1,2,3,4,5},// 'A' ~ 'D', 'a'~'d' 스타트
        {-100,1,2,3,4,5},// 'A' ~ 'D', 'a'~'d' 스타트
...
int main() {
    ...
    for (int tc = 1; tc <= TC; tc++) {
        ...
        while(throwCnt--){
            ...
            int nextPoint = PATTERN[ nowPoint ][ MOVE[move] ];
            if(DEBUG){
